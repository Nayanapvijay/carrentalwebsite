...
const CarCard = ({ car }) => {
    ...
    //Aswin - Updated this section. Because we don't recieve Images array. Only a image key and single image is coming as response
    // Also added placeholder.jpg image in public folder.
    const getCarImage = () => {
        if (car.image) {
            return car.image;
        }
        return "/placeholder.jpg?height=200&width=300";
    };
    // const getCarImage = () => {
    ...
    return (
        <Card className="overflow-hidden h-full flex flex-col">
            <div className="relative">
                <img
                    src={getCarImage() || "/placeholder.jpg"}
                    alt={car.name}
